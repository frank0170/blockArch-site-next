        ...
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          >
            ...
            >
              ...
              <p className="text-lg text-gray-400 text-center">
                Oferă instrumente pentru gestionarea finanțelor companiei,
                inclusiv contabilitate, facturare, și rapoarte financiare
                personalizate.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-lg text-gray-400 text-center">
                Asigură protecția datelor prin gestionarea accesului
                utilizatorilor, permisiuni personalizate și măsuri de securitate
                avansate pentru a preveni accesul neautorizat.
              </p>
            </div>
          </div>
        </div>
