      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">Dezvoltatorii sunt încredințați să creeze o experiență captivantă pentru companiile lor, așa că dezvoltăm instrumente pentru a-i ajuta.</p>
          </div>
        </div>
      </div>
