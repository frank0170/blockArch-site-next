      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-10 pb-12 md:pt-16 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-400" data-aos="fade-up" data-aos-delay="200">Transformă viziunile clienților în realitate, construind proiecte personalizate care se bazează pe nevoile lor.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-3 lg:gap-16 items-start md:max-w-none">
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up">
              ...
              <h4 className="h4 mb-2"><span className="text-gray-400">1</span>. Planificare</h4>
              <p className="text-lg text-gray-400 text-center">Analiza si audit tehnic al companiei, realizand un plan bazat pe nevoile curente.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200">
              ...
              <h4 className="h4 mb-2"><span className="text-gray-400">2</span>. Achizitie</h4>
              <p className="text-lg text-gray-400 text-center">Achizitia, dezvoltarea si configurarea echipamentelor propuse in plan.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400">
              ...
              <h4 className="h4 mb-2"><span className="text-gray-400">3</span>. Integrare</h4>
              <p className="text-lg text-gray-400 text-center">Integrarea sistemelor/programelor la sediul companiei.</p>
            </div>
