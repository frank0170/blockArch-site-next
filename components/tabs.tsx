      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12" data-aos-id-tabs>
            ...
            >
              Workflow integrat pentru echipele de productie
            </h2>
            <p
              ...
              data-aos-anchor="[data-aos-id-tabs]"
            >
              O soluție eficientă și optimizată pentru gestionarea proceselor de
              producție într-un mod fluid și colaborativ.
            </p>
          </div>
          ...
          <div>
            ...
            >
              ...
              >
                ...
                <span className="text-gray-400 group-hover:text-gray-200 transition-colors duration-150 ease-in-out"></span>
              </button> */}
            </div>
              ...
              >
                  ...
                  <article className="relative max-w-md mx-auto md:max-w-none">
                    ...
                    <div className="relative bg-gray-800 py-8 md:py-16 px-6 md:pr-16 md:max-w-lg lg:max-w-xl">
                      <h4 className="h4 mb-2">
                        Optimizați si scalați, de la început
                      </h4>
                      <br />
                      <p className="text-lg text-gray-400">
                        Munca în echipă este esențială pentru a obține rezultate
                        remarcabile și a atinge obiectivele propuse. Prin
                        optimizare și scalare, echipa poate obține eficiență și
                        creștere sustenabilă. În plus, abordarea noastră
                        facilitează începerea rapidă a proiectelor, permițând
                        echipelor să se angajeze rapid și să își aducă
                        contribuția într-un mod fluid și fără întârzieri.
                        Colaborarea eficientă în echipă ne permite să ne adaptăm
                        rapid la cerințele și schimbările proiectului, asigurând
                        livrarea unor rezultate de calitate superioară și
                        îndeplinirea așteptărilor clienților. În acest fel, ne
                        asigurăm că munca în echipă devine o bază solidă pentru
                        succesul proiectelor noastre.
                      </p>
                      <a
                ...
                >
                  <article className="relative max-w-md mx-auto md:max-w-none">
                    ...
                    <div className="relative bg-gray-800 py-8 md:py-16 px-6 md:pl-16 md:max-w-lg lg:max-w-xl md:ml-auto">
                      <h4 className="h4 mb-2">Munca în echipă eficientă</h4>
                      <p className="text-lg text-gray-400">
                        Eficiența este o componentă cheie pentru echipele de
                        producție și este esențială pentru a obține rezultate
                        excelente într-un timp cât mai scurt. O abordare
                        eficientă înseamnă utilizarea optimă a resurselor
                        disponibile, minimizarea pierderilor de timp și
                        reducerea activităților redundante. Echipele de
                        producție eficiente se bazează pe planificare și
                        organizare riguroasă, asigurând că fiecare membru are
                        sarcinile și resursele necesare pentru a-și desfășura
                        activitatea în mod productiv.
                      </p>
                      <a
                        className="btn-sm text-white bg-purple-600 hover:bg-purple-700 mt-6"
                        href="#0"
                ...
                >
                  <article className="relative max-w-md mx-auto md:max-w-none">
                    ...
                    <div className="relative bg-gray-800 py-8 md:py-16 px-6 md:pr-16 md:max-w-lg lg:max-w-xl">
                      <h4 className="h4 mb-2">Munca in echipa si testarea</h4>
                      <p className="text-lg text-gray-400">
                        Munca în echipă în domeniul testării este esențială
                        pentru asigurarea calității și fiabilității produselor
                        și serviciilor. Testarea în echipă implică o abordare
                        cooperativă, în care membrii echipei lucrează împreună
                        pentru a identifica și rezolva potențialele erori și
                        probleme. Echipa de testare colaborează strâns cu
                        dezvoltatorii și alte departamente pentru a înțelege
                        cerințele și specificațiile produsului sau serviciului
                        și pentru a dezvolta planuri și strategii de testare
                        adecvate.
                      </p>
                      <a
                        className="btn-sm text-white bg-purple-600 hover:bg-purple-700 mt-6"
                ...
                >
                  <article className="relative max-w-md mx-auto md:max-w-none">
                    ...
                    <div className="relative bg-gray-800 py-8 md:py-16 px-6 md:pl-16 md:max-w-lg lg:max-w-xl md:ml-auto">
                      <h4 className="h4 mb-2">Implementare este cheia</h4>
                      <p className="text-lg text-gray-400">
                        Munca în echipă în cadrul procesului de implementare
                        reprezintă o componentă esențială pentru transformarea
                        ideilor și planurilor în realitate. Prin colaborarea
                        strânsă și coordonarea între membrii echipei,
                        implementarea devine un proces fluid și eficient. Echipa
                        de implementare lucrează împreună pentru a traduce
                        cerințele și specificațiile proiectului în acțiuni
                        concrete.
                      </p>
                      <a
                        className="btn-sm text-white bg-purple-600 hover:bg-purple-700 mt-6"
