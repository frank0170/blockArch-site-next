      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Aducem ideile la viata</h2>
            <p className="text-xl text-gray-400">
              Pentru noi, la BlockArch, si cele mai proaste idei pot deveni
              povesti de viata.
            </p>
          </div>
          ...
          >
            ...
            >
              <div className="pl-2">
                ...
                <div className="flex items-center mb-3">
                  ...
                  ></div>
                  <h4 className="h4">
                    InvestNetwork a fost fondat in Arad, Romania.
                  </h4>
                </div>
                <p className="text-lg text-gray-400">
                  Fondat un start-up care avea ca scop creearea de site-uri si
                  platforme web.
                </p>
              </div>
            </div>
            ...
            >
              <div className="pl-2">
                ...
                <div className="flex items-center mb-3">
                  ...
                  ></div>
                  <h4 className="h4">
                    Dezvoltarea punctelor de lucru in orase noi, Timisoara,
                    Romania.
                  </h4>
                </div>
                <p className="text-lg text-gray-400">
                  Prima extindere a companiei, ajungand la un numar de 5
                  developeri.
                </p>
              </div>
            </div>
            ...
            >
              <div className="pl-2">
                ...
                <p className="text-lg text-gray-400">
                  Castigam primele proiecte de fonduri nerambursabile pentru a
                  dezvolta compania.
                </p>
              </div>
            </div>
            ...
            >
              <div className="pl-2">
                ...
                <p className="text-lg text-gray-400">
                  Colaborarea si fuziunea cu diferite firma de
                  consultanta/contabilitate pentru dezvoltarea de proiecte
                  pentru fonduri europene si primii clienti mari.
                </p>
              </div>
            </div>
            ...
            >
              <div className="pl-2">
                ...
                <p className="text-lg text-gray-400">
                  Inceputul departamentului de creat workstations si
                  echipamenete tehnologice custom.
                </p>
              </div>
            </div>
          </div>
