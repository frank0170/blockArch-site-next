        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">
                O companie de dezvoltare software cu 4 ani de excelență în
                afaceri, putem dezvolta soluții software fiabile, scalabile și
                sigure pentru orice sistem de operare, browser și dispozitiv.
              </div>
            </div>
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              <div className="text-sm">
                <h6 className="text-gray-200 font-medium mb-1">Produse</h6>
                <ul>
                  <li className="mb-1">
                    <Link
                      href="http://smarty-erp.ro"
              ...
              {/* 3rd block */}
              <div className="text-sm">
                <h6 className="text-gray-200 font-medium mb-1">Resurse</h6>
                <ul>
                  {/* <li className="mb-1">
              ...
              {/* 4th block */}
              <div className="text-sm">
                <h6 className="text-gray-200 font-medium mb-1">Companie</h6>
                <ul>
                  {/* <li className="mb-1">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              ...
              <li className="ml-4">
                <Link
                  href="https://github.com/frank0170"
                  className="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out"
                  aria-label="Github"
                >
                  <svg
            ...
            <div className="text-gray-400 text-sm mr-4">
              &copy; BlockArch.ro. All rights reserved.
            </div>
          </div>
        </div>
      </div>
